% Introduzione a MATLAB, Corso di Sistemi dinamici
% Gionata Salvietti & Andrea Garulli
...
%NOTA BENE: i nomi delle variabili sono case sensitive. Tipicamente gli
...
A = eye(n); % matrice identita' n x n
